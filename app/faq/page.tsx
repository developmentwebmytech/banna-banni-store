    ...
    <div className="bg-gradient-to-b from-neutral-50 to-neutral-100 min-h-screen py-0 text-black">
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-9xl mx-auto px-4">
          ...
          {/* Contact section */}
          <motion.div
            className="mt-12 mb-10 bg-gradient-to-r from-teal-600 to-teal-600 p-10 rounded-lg shadow-md text-center text-white"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <Link href="/contact">
              <button className="bg-white text-teal-600 hover:bg-teal-50 px-8 py-3 rounded-md font-medium transition-colors duration-200 shadow-sm">
                Contact Us
              </button>
            </Link>
          </motion.div>
