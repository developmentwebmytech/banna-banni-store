...
// Define a proper interface for product data
...
export default function NewArrivalsAdminPage() {
  ...
  const fetchProducts = async () => {
    setIsLoading(true)
    try {
      const res = await fetch("/api/admin/newarrivals")
      if (!res.ok) {
      ...
      const typedProducts: ProductData[] = productList.map((product: any) => ({
      ...
      toast({
        title: "Error",
        description: "Failed to load new arrival products",
        variant: "destructive",
      })
  ...
  const confirmDelete = async () => {
    ...
    try {
      const res = await fetch(`/api/admin/newarrivals/${productToDelete._id}`, {
        method: "DELETE",
      })
  ...
  return (
    <div className="space-y-6 p-8">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-semibold">New Arrival Products</h1>
        <Link href="/dashboard/newarrivals/new">
          <Button>
                ...
                <TableCell colSpan={8} className="text-center py-8">
                  <div className="flex flex-col items-center gap-2">
                    <p className="text-gray-500">
                      {searchTerm ? "No products match your search." : "No new arrival products found."}
                    </p>
                    {searchTerm && (
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem asChild>
                          <Link href={`/dashboard/newarrivals/view/${product._id}`}>
