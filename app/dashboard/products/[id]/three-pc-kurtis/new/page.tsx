...
export default function NewThreePcKurtiForProduct() {
  ...
  const handleCreate = async () => {
    ...
    try {
      await fetch(`/api/admin/products/${productId}/three-pc-kurtis/new`, {
        method: "POST",
      ...
      console.error("Error creating kurti:", error)
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-semibold text-gray-900">Add 3-Piece Kurti</h1>
              <p className="text-sm text-gray-600">Create a new 3-piece kurti entry for this product</p>
            </div>
          </div>
        </div>
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardHeader className="border-b border-gray-100 bg-gray-50/50">
            <CardTitle className="text-lg font-medium text-gray-900">Product Details</CardTitle>
            <CardDescription className="text-gray-600">
              Fill in the details for the new 3-piece kurti entry
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="p-6 space-y-8">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-medium text-gray-900 uppercase tracking-wide">Dupatta Measurements</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="dupattaLength" className="text-sm font-medium text-gray-700">
                    Dupatta Length
                  </Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="dupattaWidth" className="text-sm font-medium text-gray-700">
                    Dupatta Width
                  </Label>
                  <Select value={dupattaWidth} onValueChange={setDupattaWidth} required>
                    ...
                    <SelectContent className="bg-white border border-gray-200">
                      {dupattaWidthOptions.map((width) => (
                        <SelectItem key={width} value={width} className="hover:bg-gray-50">
                          {width}
                        </SelectItem>
                      ))}
                    </SelectContent>
