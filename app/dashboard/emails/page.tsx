      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <form onSubmit={handleSendEmail} className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <Button
                    ...
                    type="button"
                    variant="outline"
                    className="bg-blue-200 text-black hover:bg-blue-700"
        ...
        <div>
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold text-blue-600 mb-2">{subscribers.length}</div>
              <p className="text-gray-600 mb-4">Total subscribers</p>

              <Button variant="outline" className="w-full bg--600 bluetext-white hover:bg-blue-700 hover:text-white" onClick={fetchSubscribers}>
                Refresh
              </Button>
            </CardContent>
          </Card>
