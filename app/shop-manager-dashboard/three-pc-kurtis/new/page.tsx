...
export default function NewThreePcKurti() {
  ...
  const handleCreate = async () => {
    ...
    await fetch("/api/admin/three-pc-kurtis", {
      method: "POST",
    ...
    if (parentId) {
      ...
      router.push("/shop-manager-dashboard/three-pc-kurtis")
    }
  }
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        <CardTitle>Add New 3pc Kurti Entry</CardTitle>
        <CardDescription>Fill in the details for the new 3pc Kurti entry.</CardDescription>
      </CardHeader>
