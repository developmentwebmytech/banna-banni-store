...
export default function ProductEditPage({ params }: PageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push("/shop-manager-dashboard/products")
    } catch (error) {
  ...
  if (error) {
    return (
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="mt-4">
          <Button onClick={() => router.push("/shop-manager-dashboard/products")}>Back to Products</Button>
        </div>
      </div>
    )
  }
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center gap-2 text-sm text-gray-600 mb-2">
          <Button variant="outline" size="icon" asChild>
            <Link href="/shop-manager-dashboard/products">
      ...
      {!isNew && (
        <div className="bg-white border-b border-gray-200 px-6 py-4">
          <div className="flex flex-wrap gap-3">
            <Button
              variant="outline"
              onClick={() => router.push(`/shop-manager-dashboard/products/${id}/3pc-lehengas/new`)}
              disabled={isSaving}
            >
              Add 3pc Lehenga
            </Button>
            ...
            <Button
              variant="outline"
              onClick={() => router.push(`/shop-manager-dashboard/products/${id}/blouses/new`)}
              disabled={isSaving}
            >
              Add Blouses
            </Button>
            ...
            <Button
              variant="outline"
              onClick={() => router.push(`/shop-manager-dashboard/products/${id}/one-pc-kurtis/new`)}
              disabled={isSaving}
            >
              Add 1pc Kurti
            </Button>
            ...
            <Button
              variant="outline"
              onClick={() => router.push(`/shop-manager-dashboard/products/${id}/two-pc-kurtis/new`)}
              disabled={isSaving}
            >
              Add 2pc Kurti
            </Button>
            ...
            <Button
              variant="outline"
              onClick={() => router.push(`/shop-manager-dashboard/products/${id}/three-pc-kurtis/new`)}
              disabled={isSaving}
            >
              Add 3pc Kurti
            </Button>
            ...
            <Button
              variant="outline"
              onClick={() => router.push(`/shop-manager-dashboard/products/${id}/petticoat-kurtis/new`)}
              disabled={isSaving}
            >
              Add Petticoat
            </Button>
