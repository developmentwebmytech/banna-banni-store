...
export default function EditCouponClientPage({ id }: { id: string }) {
  ...
  const fetchCoupon = async () => {
    try {
      ...
      router.push("/shop-manager-dashboard/coupons")
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-6">
          <Button variant="outline" size="icon" asChild className="hover:bg-teal-600 hover:text-white bg-transparent">
            <Link href="/shop-manager-dashboard/coupons">
        ...
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => router.push("/shop-manager-dashboard/coupons")} disabled={isSaving}>
            Cancel
          </Button>
