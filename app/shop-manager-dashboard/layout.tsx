...
import { ResizableSidebar } from "@/components/shopmanager/resizable-sidebar";
        ...
        <header className="sticky top-0 z-40 border-b border-gray-400 bg-gray-50">
          <div className="relative flex h-16 items-center justify-between px-4">
            ...
            <div className="flex items-center gap-2">
              <MobileSidebar />
              <Link href="/shopmanagerdashboard">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2">
              <Link href="/shopmanagerdashboard" className="inline-block">
