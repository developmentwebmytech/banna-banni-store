...
export default function ContactPageClient() {
  ...
  const getIconComponent = (iconName: string) => {
    switch (iconName) {
      ...
      case "Phone":
        return <Phone className="h-6 w-6 text-teal-600" />
      case "Mail":
        return <Mail className="h-6 w-6 text-teal-600" />
      case "Clock":
              ...
              ([key, value], index) =>
                ...
                value !== undefined && ( // Added value !== undefined check
                  <div key={index}>
                    ...
                    <Link href={`tel:${value}`} className="text-lg font-medium text-teal-600 hover:text-teal-600">
                      {value}
                    </Link>
            ...
            {Object.entries(item.content).map(
              ([key, value], index) =>
                value !== undefined && ( // Added value !== undefined check
                  <div key={index}>
                    <p className="text-gray-600 mb-1">{key}:</p>
                    <Link href={`mailto:${value}`} className="text-teal-600 hover:text-teal-700 break-all">
                      {value}
                    </Link>
  ...
  const defaultContactInfo: ContactInfoItem[] = [
    ...
    },
    {
      ...
      title: "Email Us",
      content: {
        "General Inquiries": "info@yoursolacebuddy.com",
        "Customer Support": "support@solacebuddy.com",
      },
      icon: "Mail",
      order: 3,
    },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-white">
      ...
      <div className="relative h-[20vh] md:h-[30vh] overflow-hidden">
        <div className="absolute inset-0 bg-teal-800 flex items-center">
      ...
      <div className="container mx-auto px-4 py-12 text-black">
        <div className="max-w-8xl mx-auto px-4">
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div className="flex items-center">
                    ...
                    <label htmlFor="privacy" className="ml-2 block text-sm text-gray-700">
                      I agree to the{" "}
                      <Link href="/privacypolicy" className="text-teal-600 hover:text-teal-700">
                        Privacy Policy
                      </Link>
                    </label>
                  </div>
                  ...
                  <Button
                    type="submit"
                    disabled={submitting}
                    className="w-full bg-teal-600 hover:bg-teal-700 text-white py-3 rounded-lg flex items-center justify-center cursor-pointer"
                  >
                    {submitting ? (
                      <>
          ...
          >
            <div className="inline-block px-4 py-1 rounded-full bg-blue-100 text-teal-600 font-medium text-sm mb-4">
              Quick Help
            </div>
            ...
            <div className="bg-gradient-to-r from-teal-600 to-teal-500 rounded-2xl p-8 text-white text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/faq"
                  className="bg-white text-teal-600 px-6 py-3 rounded-lg font-medium hover:bg-blue-50 transition-colors"
                >
                  Visit FAQ Page
                </Link>
                <Link
